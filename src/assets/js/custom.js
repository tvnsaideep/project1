...
(function ($) {
	...
	function test_slide() {
		jQuery('.test-slide-show').on('click', function () {
			jQuery('.test-slide-hide').animate({ 'right': '0px' });
		});
		jQuery('.test_close').on('click', function () {
			jQuery('.test-slide-hide').animate({ 'right': '-540px' });
		});
	};
